...
- 👨‍🍳 / 👩‍🍳 **Restaurant Menu Optimizer**- It is an AI-powered restaurant menu optimizer designed to help manage menu items, sales, and costs efficiently.
...
- **❤️Heart Disease Prediction App** - A Flask-based machine learning web app designed to predict heart disease risk using user health inputs.
It utilizes Logistic Regression and a scaled dataset for accurate probability-based predictions.
The app provides personalized lifestyle, medical, and monitoring recommendations.
Users can generate and download a detailed PDF report of their results. 
...
7. **Health Disease Prediction App**- An intelligent app which uses machine learning algorithms for predicting heart disease based on different factors and lifestyle of indivuduals
